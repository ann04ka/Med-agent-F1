...
- Модели с 3-4 миллиардами параметров показывают недостаточное качество (18-41% accuracy), и файнтюнинг не обеспечит необходимый прирост качества
...
**Финальное решение**: прототип реализован с использованием **google/gemini-2.5-flash** через OpenRouter API, показавшей лучшие результаты по точности (81%) при приемлемом времени отклика (3.1 секунды).
