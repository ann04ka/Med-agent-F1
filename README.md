...
Было принято решение отказаться от агента на основе gemini-2.5 (81% точности при 3 секндах на ответ) так как точное количество параметров модели Gemini 2.5 Flash не раскрывается Google и не ясно соответствовало ли оно требованию по размеру используемой модели (не более 80b)
